...
clock_cascade = cv2.CascadeClassifier('./haarc_xml/classifier_WallClock.xml')
# clock_cascade = cv2.CascadeClassifier('./haarc_xml/cascade_toy.xml')
...
while 1:
    ...
    clocks = clock_cascade.detectMultiScale(gray, 1.3, 5)
    ...
    for (x,y,w,h) in clocks:
        ...
        cv2.putText(img,'Clock',(x,y), font, 0.5, (11,255,255), 2, cv2.LINE_AA)
